...
//actualiza las tranferencias como pausadas durante la asignación
	...
	$stm = $link->query( $sql ) or die( "Error al consultar encabezado de la trasnferencia : " . $link->error );
	$r = $stm->fetch_assoc();
...
?>
	...
	<div class="row" style="padding : 20px;">
		<div class="row">
			...
			<div class="col-5">
				<input type="text" value="<?php echo $r['folio']; ?>" class="form-control readonly text-center" readonly>
			</div>
			...
			<div class="col-6">
				<div class="input-group">
					...
					<button
						type="button"
						class="btn btn-light"
						onclick="seek_people_loged( true );"
						title="Guardar"
					>
