<?php /* Smarty version 2.6.13, created on 2022-06-01 11:22:39
...
<!-- Boton redireccion a catalogo web-->
	<button style="width: 125px; height: 125px; position: absolute; left: 45%; top: 70px; background-color: transparent; color: #6C9AC6; border: 0; border-radius: 50%; cursor: pointer; outline: none;" onclick="window.open('catalogo/index0.php');"><img src="<?php echo $this->_tpl_vars['rooturl']; ?>
...
img/img_casadelasluces/Logo.png"/>
		</a>
	</div>
    <!--Usuarios y sucursal-->
...
img/close.png" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" onclick="cierraSesion()"/></div>
	...
	<a class="detect_pc" href="<?php echo $this->_tpl_vars['rooturl']; ?>
touch_desarrollo/index.php">
	<!--class="boton"-->
...
img/puntoVenta.webp" style="width:85px;height:100px;"><!--Punto de Venta-->
	...
	<?php endif; ?> 
	<?php if ($this->_tpl_vars['ver_pantalla_responsive'] == 1): ?>	
	<a class="detect_cellphone" href="<?php echo $this->_tpl_vars['rooturl']; ?>
touch_responsive/index.php">
