<?php /* Smarty version 2.6.13, created on 2021-11-18 10:50:58
         compiled from general/listados.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'general/listados.tpl', 240, false),)), $this); ?>
...
img/imprimirmini.png" width="22" height="22" border="0" onclick="facturar('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Facturar" title="facturar Nota de Venta"/>
							...
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Visualizar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/img_casadelasluces/pdf_icon.png" width="22" height="22" border="0" onclick="viewTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Ver pdf" title="De clic para imprimir la transferencia"/>
								</td>
							<?php endif; ?>
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Imprimir" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
