...
//echo 'here';
	...
	function build_row( $r, $c, $provider_id, $type, $link ){
		...
		//monto
			$resp .= '<td id="8_'.$c.'" align="center" width="8%"  onclick="editaCelda(8,'.$c.')">0</td>';
		//	$r[10].'</td>';
		//quitar/cancelar
	...
	function getProductProviders( $product_id, $product_provider_id, $provider_id, $counter, $link ){
