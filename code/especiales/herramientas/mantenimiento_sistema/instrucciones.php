		...
		<div class="modal-content" style="width:200%; left : -50%;">
			...
			<div class="modal-body" style="text-align: justify; max-height: 400px; overflow:auto;">
				...
				<div>
					...
					<p style="color:blue;">Este botón sirve para resetear todos los campos y dependientes de los productos con orden de lista
					 en cero ( 0 )</p>
				</div>
				<br>
				<div>
					<h6 style="color:red;">Cambiar prefijo de Códigos de Barras Únicos</h6>
					<p style="color:blue;">Este botón sirve para incrementar el prefijo de los códigos de BArras únicos, 
						referente e Proveedor-Producto
					</p>
				</div>
			</div>
